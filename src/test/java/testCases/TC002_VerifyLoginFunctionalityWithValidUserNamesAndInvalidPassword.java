...
public class TC002_VerifyLoginFunctionalityWithValidUserNamesAndInvalidPassword extends BaseClass {
	
	@Test(dataProvider = "LoginDataWithValidUsernameAndInvalidPassword", dataProviderClass = DataProviders.class)
	public void testLoginWithValidUserNamesAndInvalidPassword(String username, String password) throws InterruptedException {

		logger.info("***** Starting TC_002_LoginTestWithValidUserNamesAndInvalidPassword ******");
		...
		try {
            ...
            softAssert.assertEquals(actualUrl, expectedUrl, "Unexpected URL for user: " + username);
			  ...
			  extentTest.pass("Login is unsuccessful for: " + username +
			  " with valid username " +  username + " and with Invalid password " +
			  password); }
		...
		logger.info("***** Finished TC_002_LoginTestWithValidUserNamesInvalidPassword******");
	}
