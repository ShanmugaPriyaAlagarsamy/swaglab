...
public class TC003_VerifyLoginFunctionalityWithInvalidUserNameAndValidPassword extends BaseClass {
	
	@Test(dataProvider = "LoginDataWithInvalidUsernameAndValidPassword", dataProviderClass = DataProviders.class)
	public void testLoginWithInvalidUserNameAndValidPassword(String username, String password) throws InterruptedException {

		logger.info("***** Starting TC_003_LoginTestWithInvalidUserNameAndValidPassword ******");
		...
		try {
            ...
            softAssert.assertEquals(actualUrl, expectedUrl, "Unexpected URL for user: " + username);
			  ...
			  " with Invalid username " + username + " and with valid password " +
			  password); }
		...
		logger.info("***** Finished TC_003_LoginTestWithInvalidUserNameAndValidPassword******");
	}
